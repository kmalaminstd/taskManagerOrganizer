class Uipopulation {
    populationofUi(id, taskTitleValue, taskAssignToValue, taskEndDateValue, taskPriorityValue, taskStatusValue, taskRangeValue) {
        let taskElm = `
            <tr class="taskId-${id}">
                ...
                <i class="fa fa-check" aria-hidden="true" class="taskcompleteChange tBtn"></i>
